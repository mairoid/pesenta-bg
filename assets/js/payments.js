/* Песента — конфигурация на картовите плащания (Stripe Payment Links)
   ...
   5. ВАЖНО — акаунтът се споделя с energieausweis-shop.at (същото ЮЛ, БАУФИЗИК
      ЕООД): при създаване на всеки Payment Link добави метаданни
      shop=pesenta.bg (Advanced options → Metadata в Dashboard-а). Без това
      транзакциите на двата магазина не могат надеждно да се разделят при
      месечните одиторски файлове към НАП (всеки магазин подава отделен файл
      с отделен уникален номер — виж NAP-PLAN.md). client_reference_id вече
      носи номера на поръчката (PSN-...), но той е само помощен маркер, не
      заместител на изричния shop таг.
